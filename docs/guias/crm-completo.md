# Guia completo do CRM — do zero à operação com IA
...
- **Lembrar / Soneca** — some da lista agora e volta depois: `Em 1 hora`, `Em 3 horas`, `Em 24 horas`. Quando o prazo vence, **o sistema não deixa a conversa desaparecer**: vira um item de caixa. É a regra "nada morre em silêncio" aplicada ao esquecimento honesto.
